...
def train_one_epoch(train_loader, val_loader, model, optimizer):
    pass
...
def main():
    ...
    for epoch in range(args.TRAIN.EPOCHS):
        ...
        for inputs in train_ds:
            t_outputs = train_step(inputs, model, optimizer)
        ...
        for inputs in val_ds:
            v_outputs = val_step(inputs, model)
